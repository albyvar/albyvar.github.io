...
const VERSION_CHECK_SUPPORTED = "La versione del tuo dispositivo è supportata.";
const VERSION_CHECK_NEEDS_UPGRADE = "Richiede minimo iOS %s";
const VERSION_CHECK_UNCONFIRMED = "Not ancora testato sulla versione %s";
const VERSION_CHECK_UNSUPPORTED = "Compatibile da iOS %s ad iOS %s";
